...
public class mvcmodel {
    ...
    private static final String DB_CREATE_QUERY = "CREATE TABLE " + value.defaultValue.value.DB_table_name
            + " (id integer primary key autoincrement, title text not null);";
    private final SQLiteDatabase database;
    public mvcmodel(final Context mContext) {
        this.helper = new SQLiteOpenHelper(mContext, value.defaultValue.value.DB_NAME, null, value.defaultValue.value.DB_version) {
            @Override
            ...
            public void onUpgrade(SQLiteDatabase db, int i, int i1) {
                ...
                db.execSQL("DROP TABLE IF EXISTS " + value.defaultValue.value.DB_table_name);
                this.onCreate(db);
            }
    ...
    public void deleteTask(final String field_params) {
        this.database.delete(value.defaultValue.value.DB_table_name, field_params, null);
    }
